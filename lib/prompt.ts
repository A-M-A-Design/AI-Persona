...
function articleDigests(): string {
  ...
  return [
    ...
    "en est la SYNTHÈSE, pas le texte.",
    "",
    "Dès qu'une question porte sur CE QUE DIT un article — une citation, un",
    "exemple, une image, une métaphore, une formulation, un chiffre, un passage,",
    "un développement, « comment tu dis que… », « qu'est-ce que tu racontes",
    "sur… » —, appelle l'outil lire_article avec le slug indiqué AVANT de",
    "répondre, et réponds à partir de ce qu'il renvoie. En cas de doute, appelle",
    "l'outil : un aller-retour de plus vaut mieux qu'une réponse approximative.",
    "La synthèse ci-dessous sert à savoir DE QUOI parle un article et à le citer",
    "par son titre — pas à en restituer le contenu.",
    "",
    ...entries,
    "",
